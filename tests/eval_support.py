    ...
    *,
        ...
        rows.append(
            {
                ...
                "wave_request_timings": p1.get("request_timings"),
                "base_hook_report": base.get("hook_report"),
                "wave_hook_report": p1.get("hook_report"),
                ...
                "runtime_adaptive_total": p1_sched.get("runtime_adaptive_total"),
                "runtime_effective_pressure_avg": p1_sched.get("runtime_effective_pressure_avg"),
                "runtime_wall_pressure_avg": p1_sched.get("runtime_wall_pressure_avg"),
                "runtime_short_urgency_avg": p1_sched.get("runtime_short_urgency_avg"),
                "runtime_target_fraction_avg": p1_sched.get("runtime_target_fraction_avg"),
                "runtime_target_chunk_avg": p1_sched.get("runtime_target_chunk_avg"),
                "runtime_queue_avg": p1_sched.get("runtime_queue_avg"),
                "runtime_waiting_short_avg": p1_sched.get("runtime_waiting_short_avg"),
    ...
    return {
        ...
        "summary": {
            ...
            "runtime_adaptive_total": stats([r.get("runtime_adaptive_total") for r in rows]),
            "runtime_effective_pressure_avg": stats([r.get("runtime_effective_pressure_avg") for r in rows]),
            "runtime_wall_pressure_avg": stats([r.get("runtime_wall_pressure_avg") for r in rows]),
            "runtime_short_urgency_avg": stats([r.get("runtime_short_urgency_avg") for r in rows]),
            "runtime_target_fraction_avg": stats([r.get("runtime_target_fraction_avg") for r in rows]),
            "runtime_target_chunk_avg": stats([r.get("runtime_target_chunk_avg") for r in rows]),
            "runtime_queue_avg": stats([r.get("runtime_queue_avg") for r in rows]),
            "runtime_waiting_short_avg": stats([r.get("runtime_waiting_short_avg") for r in rows]),
        },
    }
            ...
            strict_eval_rows.append(
                {
                    ...
                    "base_request_timings": lora_base.get("request_timings"),
                    "strict_request_timings": lora_p2_strict.get("request_timings"),
                    "base_hook_report": lora_base.get("hook_report"),
                    "strict_hook_report": strict_report,
