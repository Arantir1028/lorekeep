...
DEFAULT_EXPERIMENT_MODELS: list[ExperimentModelSpec] = [
    ExperimentModelSpec(
        ...
        _checkpoint_lut_name("mistralai/Mistral-7B-v0.1"),
    ),
    ExperimentModelSpec(
        "mistral-7b-instruct-v0.2",
        "mistralai/Mistral-7B-Instruct-v0.2",
        _checkpoint_lut_name("mistralai/Mistral-7B-Instruct-v0.2"),
    ),
    ExperimentModelSpec(
        "zephyr-7b-beta",
        "HuggingFaceH4/zephyr-7b-beta",
        _checkpoint_lut_name("HuggingFaceH4/zephyr-7b-beta"),
    ),
    ExperimentModelSpec(
        "openchat-3.5-0106",
        "openchat/openchat-3.5-0106",
        _checkpoint_lut_name("openchat/openchat-3.5-0106"),
    ),
    ExperimentModelSpec(
        "gemma-7b-it", "google/gemma-7b-it", _checkpoint_lut_name("google/gemma-7b-it")
    ),
    ExperimentModelSpec(
        "decilm-7b",
        "Deci/DeciLM-7B",
        _checkpoint_lut_name("Deci/DeciLM-7B"),
        trust_remote_code=True,
    ),
    ExperimentModelSpec(
        "phi-2",
        "microsoft/phi-2",
        _checkpoint_lut_name("microsoft/phi-2"),
        max_model_len_override=2048,
    ),
    ExperimentModelSpec(
        "baichuan2-7b-chat",
        "baichuan-inc/Baichuan2-7B-Chat",
        _checkpoint_lut_name("baichuan-inc/Baichuan2-7B-Chat"),
        trust_remote_code=True,
    ),
]
